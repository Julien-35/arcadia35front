...
export const allRoutes = [
    ...
    new Route("/admin", "Administrateur", "page/connecte/admin.html", [], "js/connexion/admin.js"),
    new Route("/employe", "Employe", "page/connecte/employe.html", ["ROLE_EMPLOYE","ROLE_ADMIN"], "js/connexion/employe.js"),
    ...
    new Route("/veterinaire", "Veterinaire", "page/connecte/veterinaire.html", ["ROLE_VETERINAIRE","ROLE_ADMIN"], "js/connexion/veterinaire.js"),
    new Route("/inscription", "inscrire utilisateur", "page/connecte/inscription.html", [], "js/connexion/inscription.js"),
    new Route("/post", "post", "page/connecte/post.html", [], "js/connexion/post.js"),
