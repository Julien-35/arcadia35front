...
async function voirHoraire() {
    ...
    try {
        const items = await fetchData("https://arcadia35380-f680d3a74682.herokuapp.com/api/horaire/get", myHeaders);
...
async function voirRace() {
    ...
    try {
        const races = await fetchData("https://arcadia35380-f680d3a74682.herokuapp.com/api/race/get", myHeaders);
...
async function modifierAnimal(animalId, oldImageData) {
    ...
    try {
        const response = await fetch(`https://arcadia35380-f680d3a74682.herokuapp.com/api/animal/${animalId}`, {
            method: 'PUT',
            headers: myHeaders,
